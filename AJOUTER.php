   ...
   <?php
                                ...
                                if (isset($_POST['sub'])){
                                    ...
                                    $ownerid = $_POST["ownerid"];
                                        ...
                                        $sql="INSERT INTO events (idv,name,description,university,date,ownerid)
                                        VALUES('$idv','$name','$description','$university','$date','$ownerid')";
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td> <input type="text" class="form-control" name="identifiant" id="identifiant"  value="<?php
                                        echo rand();?>" required></td>
                                        ...
                                        <td><input type="text" class="form-control" name="ownerid" id="ownerid"  required></td>
                                        <td><input class="btn btn-primary" href="eventslist.php" name="sub"  id="sub" type="submit"  ></td>
                                    </tr>
